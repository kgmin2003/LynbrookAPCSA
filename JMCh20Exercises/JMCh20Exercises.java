...
public class JMCh20Exercises<E>
{
    ...
    public ListNode<String> concatenateStrings( ListNode<String> head )
    {
        ...
        ListNode<String> newList = new ListNode<String>( head.getValue(),
            null );
        // why not head?
        ListNode<String> node1 = newList;

        while ( head.getNext() != null )
        {
            String value = newList.getValue() + head.getNext().getValue();
            newList.setNext( new ListNode<String>( value, null ) );
            head = head.getNext();
    ...
    public ListNode<String> insertInOrder( ListNode<String> head, String s )
    {
        ...
        if ( head == null )
        {
            head = ( new ListNode<String>( s, null ) );
            return head;
        }

        ListNode<String> node1 = head;
        ...
        while ( head.getNext() != null )
        {
            ...
            if ( head.getValue().compareTo( s ) < 0
                && head.getNext().getValue().compareTo( s ) > 0 )
            {
                ListNode<String> newNode = new ListNode<String>( s,
                    head.getNext() );
        ...
        ListNode<String> newNode = new ListNode<String>( s, null );
        head.setNext( newNode );
        return node1;
    }
     ...
     * @return the head of the updated list
     */
    public ListNode<String> moveToBack(
    ...
    public static void sort( ListNode<String> head )
    {
        ...
        ListNode<String> firstNode = head;
        int length = size( head );
        ListNode<String> count = head;

        for ( int i = 0; i < length - 1; i++ )
        {
            ListNode<String> newNode = new ListNode<String>(
                firstNode.getValue(), null );
            head = firstNode;
            count = firstNode;
            ...
            for ( int j = length - i; j > 1; j-- )
            {
                ...
                {
                    newNode = new ListNode<String>( head.getValue(), null );
                    count = head;

                }
            }
            
            ListNode<String> node = new ListNode<String>( head.getValue(), null );           
            
            head.setValue(  newNode.getValue() );
            count.setValue( node.getValue() );
    ...
    /**
     * 
     * Help method sizeFor with string list node
     * 
     * @param head
     *            string list node
     * @return int size
     */
    public static int size( ListNode<String> head )
    {
        int size;
        for ( size = 0; head != null; size++ )
        {
    ...
    {
        ListNode2<Integer> newNode = new ListNode2<Integer>( head
            .getValue(), null, null );
        ListNode2<Integer> count = head;
        ListNode2<Integer> topNode = head;
        ...
        while ( head.getNext() != null )
        {
            ...
            if ( head.getValue().compareTo( newNode.getValue() ) > 0 )
            {
                newNode = new ListNode2<Integer>( head.getValue(),
                    null,
                    null );
                count = head;
            }
        }
        count.getPrevious().setNext( count.getNext() );
        count.getNext().setPrevious( count.getPrevious() );
        return topNode;
    }
    ...
    public static <E> String strList2( ListNode2<E> head )
    {
        ...
        for ( ListNode2<E> node = head; node != null; node = node
            .getNext() )
        {
    ...
    public static void main( String[] args )
    {
        ...
        do
        {
            ...
            System.out
                .println( "   (4) 20-4a sizeFor( ListNode<E> head )" );
            System.out
                .println( "   (5) 20-4b sizeRecur( ListNode<E> head )" );
            System.out
            ...
            System.out
                .println( "   (D) 20-13 sort( ListNode<String> head )" );
            System.out.println(
            ...
            if ( response.length() > 0 )
            {
                ...
                switch ( response.charAt( 0 ) )
                {
                    ...
                    case '7':
                        ...
                        System.out
                            .println( "Original: " + strList( head7 ) );
                        ListNode<String> revHead = ex.reverseList( head7 );
                        System.out
                            .println( "Reverse: " + strList( revHead ) );
                    ...
                    case '8':
                        ...
                        System.out
                            .println( "Original: " + strList( head8 ) );
                    ...
                    case '9':
                        ...
                        System.out
                            .println( "Original: " + strList( head9 ) );
                    ...
                    case 'a':
                        ...
                        System.out
                            .println( "Original: " + strList( headA ) );
                    ...
                    case 'b':
                        ...
                        System.out
                            .println( "Original: " + strList( headB ) );
                        ListNode<String> midNode = ex.middleNode( headB );
                        System.out.println(
                            "Middle Node: " + strList( midNode ) );
                    ...
                    case 'c':
                        ListNode<String> headC = buildList(
                            new String[] { "Santa Clara", "San Jose",
                                "San Bruno", "Gilroy" } );
                        System.out
                            .println( "Original: " + strList( headC ) );
                        insHead = ex.moveToBack( headC, "San ?????" );
                        System.out.println(
                            "moveToBack( headC, \"San ?????\" ): "
                                + strList( insHead ) );
                        break;
                    case 'D':
                    case 'd':
                        ListNode<String> headD = buildList(
                            new String[] { "Santa", "bunny", "newt",
                                "apple", "aardvark", "zebra" } );
                        System.out
                            .println( "Original: " + strList( headD ) );
                        sort( headD );
                    ...
                    case 'e':
                        ...
                        System.out
                            .println( "Original: " + strList2( headE ) );
                        ListNode2<Integer> maxHead = removeMax( headE );
                        System.out.println(
                            "removeMax: " + strList2( maxHead ) );
                        break;
                    case 'F':
                    case 'f':
                        ListNode2<Double> headF = buildList2(
                            new Double[] { 101.0, 22.2, 3.22, 1234.0,
                                99.9 } );
                        ListNode2<Double> tailF = headF.getNext()
                            ...
                            .getNext();
                        System.out
                            .println( "Original: " + strList2( headF ) );
